              ...
              {users.length === 0 ? (
                ...
                users.map((u) => (
                  <tr key={u._id} className="hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`flex w-fit items-center gap-1 rounded-full px-2 py-0.5 text-xs font-medium ${u.userRole === "admin" ? "bg-purple-100 text-purple-800" : "bg-gray-100 text-gray-700"}`}
                      >
                        {u.userRole === "admin" ? (
